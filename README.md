...
[DropThe](https://dropthe.org) is one of the largest independent entity databases on the web, tracking nearly **2 million entities** connected by **3.4 million knowledge graph relationships** across entertainment, technology, finance, gaming, and more.
...
| Metric | Count |
|--------|-------|
| Entities tracked | 1,940,000+ |
| Knowledge graph links | 3,400,000+ |
| Entity facts (intelligence) | 143,000+ |
| Streaming availability records | 685,000+ |
| Name intelligence records | 20,925 |
| Countries with World Bank indicators | 246 |
| Entity categories | 17 |
| People with ethical Good Scores | 76,950 |

## Core Systems

- **[Entity Database](entity-database/)** -- 1.94M entities across 17 categories
- **[Knowledge Graph](knowledge-graph/)** -- 3.4M verified relationships mapping how entities connect
- **[Streaming Data](streaming-data/)** -- 685K records tracking what's available where
